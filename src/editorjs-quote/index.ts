...
export default class Quote implements BlockTool {
     ...
     */
    private readonly quotePlaceholder: string;
     ...
     */
    private readonly captionPlaceholder: string;
    ...
    public render(): HTMLElement {
        ...
        const quote = make('div', [this.css.input, this.css.text, this.css.textTune], {
